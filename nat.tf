...
# Attach Primary Private subnet with Private Route Table
...
# Attach Secondary private subnet with Private Route Table
resource "aws_route_table_association" "secondary-demo-private-1-a" {
  subnet_id      = aws_subnet.demo-secondary-private-1.id
  route_table_id = aws_route_table.demo-private.id
}


resource "aws_route_table_association" "secondary-demo-private-2-a" {
  subnet_id      = aws_subnet.demo-secondary-private-2.id
  route_table_id = aws_route_table.demo-private.id
}
